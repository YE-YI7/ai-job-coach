            ...
            <div className="w-10 h-10 rounded-xl overflow-hidden shadow-md ring-2 ring-orange-100">
              <img
                ...
                onError={(e) => {
                  ...
                  if (parent) {
                    parent.className = 'w-10 h-10 rounded-xl bg-gradient-to-br from-orange-500 to-amber-500 flex items-center justify-center shadow-md ring-2 ring-orange-100';
